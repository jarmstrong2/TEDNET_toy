...
--local mixcrit = function(input, target)
--	print(input) 
--  return criterion:forward(input)
--end

--model.criterion = autograd.nn.AutoCriterion('AutoMIX')(mixcrit)
...
if opt.modelReload == true then
    print('reloading model file:')
    print(opt.modelFilename)
